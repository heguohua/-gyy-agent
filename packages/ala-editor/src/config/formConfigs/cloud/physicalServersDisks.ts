 ...
 * @LastEditTime: 2025-08-25 17:03:31
...
import { alaDetailBuild, alaDetailDate, alaDetailImage, alaDetailInput, alaDetailSelectTable, alaDetailSelectTree } from "@/config/alaDetailBuilder"
...
export const physicalServersDisks: FormConfig = {
    ...
    detailFields: [
        ...
        alaDetailSelectTable('roles', "系统角色", "name", 1, false, { columnWidth: { desktop: '200' } }),
