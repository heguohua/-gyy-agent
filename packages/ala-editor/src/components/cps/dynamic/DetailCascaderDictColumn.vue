 ...
 * @LastEditTime: 2025-11-19 21:45:19
 * @FilePath: /1-low-coding/packages/ala-editor/src/components/cps/dynamic/DetailCascaderDictColumn.vue
 * @Description: 
 * 
...
const showValue = computed(() => {
    const fieldName = props.formItem.formData.fieldName?.desktop
    return props.data[fieldName + 'Name'] || props.data?.item?.[fieldName + 'Name']
})
