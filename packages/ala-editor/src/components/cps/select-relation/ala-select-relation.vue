 ...
 * @LastEditTime: 2025-12-25 11:20:09
 * @FilePath: /1-low-coding/packages/ala-editor/src/components/cps/select-relation/ala-select-relation.vue
 * @Description: 
 * 
 * Copyright (c) 2024 by 【 tech.darcy.zhang@outlook.com 】, All Rights Reserved. 
-->
<template>
  <div class="ala-select-relation-wrapper">
    ...
    <el-form-item :label="label" :label-position="position" :prop="fieldName">
      ...
      <el-select @change="handleChange" :model-value="model" class="ala-select-relation-group" :style="styles" :id="fieldName"
        :disabled="isDisabled">
