 ...
 * @LastEditTime: 2024-12-28 11:05:01
 * @FilePath: /1-low-coding/packages/ala-editor/src/components/flow/PropertySetting/join.vue
 * @Description: 
 * 
...
<template>
  <div>
    <el-form ref="formRef" :model="modelForm" label-width="80px" size="default" :rules="rules">
