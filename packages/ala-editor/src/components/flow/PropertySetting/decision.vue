 ...
 * @LastEditTime: 2025-01-03 15:26:53
 * @FilePath: /1-low-coding/packages/ala-editor/src/components/flow/PropertySetting/decision.vue
 * @Description: 
 * 
...
import { alaBuildInput, alaBuildSelectDict, alaBuildTextarea } from '@/config/alaBuilders'
...
fields.value.push(alaBuildInput("expr", "决策表达式", [alaRequired()], "请输入决策表达式"))
fields.value.push(alaBuildTextarea("handleClass", "处理类", [], "请输入处理类名称"))
