...
-->
<template>
  <div class="editor-select-component-wrapper">

    <div class="ala-el-dialog-wrapper" v-if="dialogShow">
      <el-dialog v-model="dialogShow" :width="dialogWidth" :append-to-body="true" :showClose="true">

        <template #header="{ titleId, titleClass }">
          <div class="editor-select-component-header">
...
const generateValue = (value: string) => {
  return `<p class='editor-select-component-value'>${value}</p>`
}
...
.editor-select-component-wrapper {
...
.editor-select-component-header {
  padding-left: 12px;
}

.editor-select-component-value {
