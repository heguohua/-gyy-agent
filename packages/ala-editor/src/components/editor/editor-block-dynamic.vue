 ...
 * @LastEditTime: 2025-01-12 20:24:57
 * @FilePath: /1-low-coding/packages/ala-editor/src/components/editor/editor-block-dynamic.vue
 * @Description: 
 * 
    ...
    <div class="editor-block">
        ...
        <div class="right">
            <el-collapse v-model="activeNames" @change="handleChange">
                ...
                <!-- 渲染组件 -->
                <template class="" v-for="(item, index) in blocks" :key="index">
                    <el-collapse-item :title="$t(item.name)" :name="item.name">

                        <editor-block-drag-page :list="item.blocks" :sort="false"
                            :group="{ name: dragGroup, pull: 'clone', put: false }" :bType="bType">
                        </editor-block-drag-page>
