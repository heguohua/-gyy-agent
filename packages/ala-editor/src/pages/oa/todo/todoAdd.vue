 ...
 * @LastEditTime: 2025-08-26 10:35:07
...
const basicFields = computed(() => {
    return [
        ...
        // alaDetailDate( 'startTime', "开始时间", 'YYYY-MM-DD HH:mm:ss', undefined, undefined, { columnWidth: { desktop: '200' } }),
        // alaDetailDate( 'endTime', "结束时间", 'YYYY-MM-DD HH:mm:ss', undefined, undefined, { columnWidth: { desktop: '200' } }),
