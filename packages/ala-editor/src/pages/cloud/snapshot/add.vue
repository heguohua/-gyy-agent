 ...
 * @LastEditTime: 2025-09-03 17:58:51
 * @FilePath: /1-low-coding/packages/ala-editor/src/pages/cloud/snapshot/add.vue
 * @Description: 
 * 
...
<template>
    ...
    <AlaBaseForm v-model="showDrawer" @confirm="confirm" v-bind="props" :fields="formConfigs.snapshot.formFields" :formData="formData"
        :columnNum="1" labelPosition="top" :moduleName="moduleName" :url="url" :updateUrl="updateUrl"
        :tipTitle="$t('pop.warm_title')" :formAttr="formConfigs.snapshot.formAttr" :beforeSave="beforeSave" />
...
// ##########################  以下当前模块自定义业务逻辑处理部分  #########################################
const url = '/c/snapshot/add'
const updateUrl = '/c/snapshot/update'
// 表单数据保存对象
...
const basicFields = computed(() => {
    return formConfigs.snapshot.formFields
})
