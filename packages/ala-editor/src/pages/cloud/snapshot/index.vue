...
<template>
    ...
    <AlaDetail :data="detailItem" v-model="showDetailPage" :fields="formConfigs.snapshot.detailFields"
        :formAttr="formConfigs.snapshot.detailAttr" />
...
import Add from '@/pages/cloud/snapshot/add.vue';
...
const url = formConfigs.snapshot.pageApi
const deleteUrl = "/c/snapshot/delete"
