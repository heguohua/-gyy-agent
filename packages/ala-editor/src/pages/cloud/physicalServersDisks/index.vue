...
<template>
    ...
    <!-- 分页列表 -->
    <PageTable ref="pageRef" :url="url" :deleteUrl="deleteUrl" :columns="formConfigs.physicalServersDisks.pageFields"
...
import Add from '@/pages/cloud/physicalServersDisks/add.vue';
...
const url = formConfigs.physicalServersDisks.pageApi
const deleteUrl = "/c/physicalServersDisks/delete"
