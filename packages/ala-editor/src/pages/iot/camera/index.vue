 ...
 * @LastEditTime: 2025-08-04 18:10:40
...
<template>
    <div class="page">
        ...
        <div class="left">
            <AlaTree title="摄像头安装位置" addUrl="/iot/deviceAreaGroup/add" treeUrl="/iot/deviceAreaGroup/tree"
...
// 查询条件
const params = reactive({ profileIds: [14, 50, 52, 145] }) as { [key: string]: any }
...
const url = camera.pageApi
const deleteUrl = "/iot/device/delete"

// 分页列表中列属性配置
const columns = computed(() => {
    return camera.pageFields
})
/**
 * 详情页面字段
 */
const detailFields: any = ref(camera.detailFields)

// 基础查询条件
const baseFields = computed(() => {
    return [
        alaBuildInput("deviceName", '摄像头名称'),
    ]
})
...
const formAttr = ref(camera.formAttr)
