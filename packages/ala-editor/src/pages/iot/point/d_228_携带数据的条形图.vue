 ...
 * @LastEditTime: 2025-05-30 16:33:35
 * @FilePath: /1-low-coding/packages/ala-editor/src/pages/iot/point/d_228_携带数据的条形图.vue
 * @Description: 
 * 
...
onMounted(() => {
    ...
    const title = ad3.aText(group, "携带数据的条形图", aTitleAttrs)
    // 添加文本后再次修改文本样式
