 ...
 * @LastEditTime: 2025-05-30 15:54:18
 * @FilePath: /1-low-coding/packages/ala-editor/src/pages/iot/point/d_226_横向透明度渐变条形图.vue
 * @Description: 
 * 
...
onMounted(() => {
    ...
    const title = ad3.aText(group, "横向透明度渐变条形图", aTitleAttrs)
    // 添加文本后再次修改文本样式
