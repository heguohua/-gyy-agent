 ...
 * @LastEditTime: 2025-05-27 09:54:12
 * @FilePath: /1-low-coding/packages/ala-editor/src/pages/iot/point/d_2_d3坐标轴_数值型上坐标.vue
 * @Description: 
 * 
...
onMounted(() => {
    ...
    const title = ad3.aText(group, "数值型上坐标", aTitleAttrs)
    // 添加文本后再次修改文本样式
    // title.attr("fill", '#ef4d4b')

    const xScale = ad3.aScaleLinear(data, [0, width])

    const ticks = ad3.aTick(xScale, 'top')
