 ...
 * @LastEditTime: 2025-05-27 09:53:48
 * @FilePath: /1-low-coding/packages/ala-editor/src/pages/iot/point/d_3_d3坐标轴_数值型下坐标.vue
 * @Description: 
 * 
...
onMounted(() => {
    ...
    const title = ad3.aText(group, "数值型下坐标", aTitleAttrs)
    // 添加文本后再次修改文本样式
