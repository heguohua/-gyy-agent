 ...
 * @LastEditTime: 2025-08-26 10:20:46
 * @FilePath: /1-low-coding/packages/ala-editor/src/pages/storage/kuqukuwei/index.vue
 * @Description: 
 * 
...
<template>
    <div class="page">
        ...
        <div class="left">
            <AlaTree title="库区库位" addUrl="/w/warehouseLocationGroup/add" treeUrl="/w/warehouseLocationGroup/tree"
                deleteUrl="/w/warehouseLocationGroup/delete" updateUrl="/w/warehouseLocationGroup/update" />
        </div>
        <div class="right">
...
import Add from '@/pages/storage/kuqukuwei/add.vue';
