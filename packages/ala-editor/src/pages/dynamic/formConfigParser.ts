 ...
 * @LastEditTime: 2025-07-24 10:56:33
        ...
        if (response.code === 200) {
            ...
            if (config.pageConfig?.form) {
                ...
                if (formType === 'flow') {
                    ...
                    const col = alaDetailFlowInstanceState('instanceState', "流程状态", [{ '进行中': '10', 'color': colors.primary }, { '已完成': '20', 'color': colors.primary }, { '已拒绝': '45', 'color': colors.warning }, { '已退回': '60', 'color': colors.danger }], undefined, undefined, { columnWidth: { desktop: '120' } })
