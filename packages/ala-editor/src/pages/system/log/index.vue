 ...
 * @LastEditTime: 2025-10-03 22:00:59
 * @FilePath: /1-low-coding/packages/ala-editor/src/pages/system/log/index.vue
 * @Description: 
 * 
...
<template>
    ...
    <!-- 分页列表 -->
    <PageTable ref="pageRef" :url="url" :columns="formConfigs.systemLog.pageFields" :params="params"
        :showSelectCheckbox="false" @add="showAdd" @edit="showEdit" :tipTitle="$t('pop.warm_title')" :noButtons="true">
    ...
    <AlaDetail :data="detailItem" v-model="showDetailPage" :fields="formConfigs.systemLog.detailFields"
        :formAttr="formConfigs.systemLog.detailAttr" />
...
const url = formConfigs.systemLog.pageApi
