 ...
 * @LastEditTime: 2026-01-12 22:37:57
 * @FilePath: /1-low-coding/packages/ala-editor/src/pages/system/app/add.vue
 * @Description: 
 * 
...
<template>
    ...
    <AlaBaseForm v-model="showDrawer" @confirm="confirm" v-bind="props" :fields="formConfigs.app.formFields" :formData="formData"
        :columnNum="1" labelPosition="top" :moduleName="moduleName" :url="url" :updateUrl="updateUrl"
        :tipTitle="$t('pop.warm_title')" :formAttr="formConfigs.app.formAttr" :beforeSave="beforeSave" />
...
const basicFields = computed(() => {
    return formConfigs.app.formFields
})
