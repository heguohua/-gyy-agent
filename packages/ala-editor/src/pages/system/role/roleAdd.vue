...
<template>
    ...
    <AlaBaseForm v-model="showDrawer" @confirm="confirm" v-bind="props" :fields="formConfigs.systemRole.formFields"
        :formData="formData" :columnNum="1" labelPosition="top" :moduleName="moduleName" :url="url"
        :updateUrl="updateUrl" :tipTitle="$t('pop.warm_title')" :formAttr="formConfigs.systemRole.formAttr"
...
// ##########################  以下当前模块自定义业务逻辑处理部分  #########################################
const url = '/u/role/add'
const updateUrl = '/u/role/update'
// 表单数据保存对象
...
const basicFields = computed(() => {
    return formConfigs.systemRole.formFields
})
